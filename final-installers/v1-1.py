...
info = {'python': None, 'license_accepted': False,
        'installtion_complete': False, 'username': None, 'home': None, 'php': None,'host':False,'secret':None,'version':'1.1'}
...
git_proccess = os.popen(
    'sudo git clone https://github.com/mwxgaf/pylocalhost.git --branch v1.1 --single-branch temp')
